...
import { Booking_booking, UpdateStatusBooking, UpdateStatusBookingVariables } from 'types/schema-types'
...
type FuncMutation = {
  updateStatusBooking: MutationFunc<UpdateStatusBooking, UpdateStatusBookingVariables>,
}

type Props = {
  data: Booking_booking
...
const WithCompose = compose(
  graphql<{}, UpdateStatusBooking, UpdateStatusBookingVariables, {}>(UPDATE_STATUS_BOOKING,{
