...
import { UploadProductPhotoM, UploadProductPhotoMVariables, DeleteProductPhoto, DeleteProductPhotoVariables, UpdateProduct, UpdateProductVariables, Product_product_photo, Product_product } from 'types/schema-types'
...
type FuncMutation = {
  ...
  updateProduct: MutationFunc<UpdateProduct, UpdateProductVariables>,
}
...
const initialState = {
  filelist: {} as Product_product_photo,
  description: ''
}
...
const WithCompose = compose(
  graphql<{}, UploadProductPhotoM, UploadProductPhotoMVariables, {}>(UPLOAD_PRODUCT_PHOTO, {
    name: 'uploadPhotoMutation'
  }),
  graphql<{}, DeleteProductPhoto, DeleteProductPhotoVariables, {}>(DELETE_PRODUCT_PHOTO, {
    name: 'deletePhotoMutation'
  }),
  graphql<{}, UpdateProduct, UpdateProductVariables, {}>(UPDATE_PRODUCT,{
    name: 'updateProduct'
  }),
  Form.create({}),
)(FormEditProduct)
