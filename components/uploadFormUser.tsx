...
import { MeQ_me_photo, ProductsConnectionQ_productsConnection_edges_node_photo as ProductPhoto, Product_product_photo } from 'types/schema-types'
...
type Props = {
  defaultPhoto: MeQ_me_photo | ProductPhoto | Product_product_photo | null
