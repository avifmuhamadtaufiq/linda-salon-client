...
import { SearchBookingsByUser, SearchBookingsByUserVariables, SearchBookingsByUser_searchBookingsByUser_edges as TypeNode } from 'types/schema-types'
...
class BookingsQuery extends Query<SearchBookingsByUser, SearchBookingsByUserVariables> {}
          ...
          if ( 
            ...
            return (
              <Table
                ...
                columns={columns}
                rowKey={(record: TypeNode) => record.node.id}
                pagination={{
                  style: { margin: "24px 0" },
                  position: "bottom",
                  defaultPageSize: 10,
                ...
                expandedRowRender={(record: TypeNode) => {
