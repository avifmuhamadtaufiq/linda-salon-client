...
import { AddProductToBookingM, AddProductToBookingMVariables } from 'types/schema-types'
...
class AddProductToBooking extends Mutation<AddProductToBookingM, AddProductToBookingMVariables>{}
...
class ActionCard extends Component<Props, State> {
  ...
  handleOnOk = (addProduct: MutationFn<AddProductToBookingM, AddProductToBookingMVariables>) => () => {
