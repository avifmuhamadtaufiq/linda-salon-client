...
import { MeQ, FilterProductByDateGivenQ_filterProductByDateGiven_edges_node } from 'types/schema-types'
...
type Props = {
  ...
  product: FilterProductByDateGivenQ_filterProductByDateGiven_edges_node,
  ...
  >
    <ApolloConsumer>
      {( client ) => {
        ...
        if ( idCreatedBooking ) {
          const dataMe = client.readQuery<MeQ>({ query: ME_QUERY })
