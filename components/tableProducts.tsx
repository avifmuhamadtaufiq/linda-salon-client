...
import {
  ProductsConnectionQ_productsConnection_edges_node as ProductNode,
  ProductsConnectionQ_productsConnection_edges as ProductEdge,
  DeleteProduct,
  DeleteProductVariables,
  DeleteManyProduct,
  DeleteManyProductVariables
...
type Props = {
  ...
  deleteProduct: MutationFunc<DeleteProduct, DeleteProductVariables>,
  deleteManyProduct: MutationFunc<DeleteManyProduct, DeleteManyProductVariables>
}
...
const initialState = {
  ...
  selectedRowIds: [] as ProductNode['id'][],
  currentPage: 1
}
...
class TableProducts extends Component<Props, State> {
  ...
  private onSelectChange = (record: ProductEdge) => {
  ...
  private onSelectAll = (selected: boolean, selectedRows: ProductEdge[]) => {
    if (selected) {
...
export default compose(
  graphql<{}, DeleteProduct, DeleteProductVariables, {}>(DELETE_PRODUCT, {
    name: "deleteProduct"
  }),
  graphql<{}, DeleteManyProduct, DeleteManyProductVariables, {}>(DELETE_MANY_PRODUCT, {
