...
import { BookingMenuFragment, DeleteBookingM, DeleteBookingMVariables, MeQ } from 'types/schema-types'
...
class RemoveFromBooking extends Mutation<DeleteBookingM, DeleteBookingMVariables> {}
