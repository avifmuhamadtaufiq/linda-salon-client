...
import { 
  RemoveItemFromBookingM,
  RemoveItemFromBookingMVariables,
  SendBookingM,
  SendBookingMVariables,
  BookingMenuFragment,
  MeQ,
...
class SendBooking extends Mutation<SendBookingM, SendBookingMVariables> {}
class RemoveItem extends Mutation<RemoveItemFromBookingM, RemoveItemFromBookingMVariables> {}
...
class FormDrawer extends Component<Props, {}> {  
  ...
  private handleSend = (sendBookingM: MutationFn<SendBookingM, SendBookingMVariables>) => () => {
      ...
      if (!err) {
        sendBookingM({
          ...
          update: ( client, result ) => {
            const readQuery = client.readQuery<MeQ>({ query: ME_QUERY })
            const { data } = result
  ...
  private removeItem = (removeItemM : MutationFn<RemoveItemFromBookingM, RemoveItemFromBookingMVariables>, idItem: string) => () => {
