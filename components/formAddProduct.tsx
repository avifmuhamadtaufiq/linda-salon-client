...
import { CreateProduct, CreateProductVariables, DeleteProductPhoto, DeleteProductPhotoVariables, UploadProductPhotoM, UploadProductPhotoMVariables, ProductsConnectionQ_productsConnection_edges_node_photo as ProductPhoto } from 'types/schema-types'
...
type FuncMutation = {
  uploadPhotoMutation: MutationFunc<UploadProductPhotoM, UploadProductPhotoMVariables>,
  deletePhotoMutation: MutationFunc<DeleteProductPhoto, DeleteProductPhotoVariables>,
  createProduct: MutationFunc<CreateProduct, CreateProductVariables>,
}
      ...
      if (!err && createProduct && filelist && filelist.id && description !== '') {
        createProduct({
          variables: {
            ...
            price: fieldsValue['stock'],
            stock: fieldsValue['price'],
            tag ,
...
const FormAddProductWithCompose = compose(
  graphql<{}, UploadProductPhotoM, UploadProductPhotoMVariables, {}>(UPLOAD_PRODUCT_PHOTO2, {
    name: 'uploadPhotoMutation'
  }),
  graphql<{}, DeleteProductPhoto, DeleteProductPhotoVariables, {}>(DELETE_PRODUCT_PHOTO3, {
    name: 'deletePhotoMutation'
  }),
  graphql<{}, CreateProduct, CreateProductVariables, {}>(CREATE_PRODUCT,{
    name: 'createProduct'
  }),
  Form.create({}),
)(FormAddProduct)
