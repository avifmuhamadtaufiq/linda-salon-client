...
import {
  DeleteBookingM,
  DeleteBookingMVariables,
  DeleteManyBooking,
  DeleteManyBookingVariables,
  BookingConnection_bookingConnection_edges_node as BookingNode,
  BookingConnection_bookingConnection_edges as BookingEdge,
  BookingConnection,
  BookingConnectionVariables,
...
type Props = {
  ...
  deleteBooking: MutationFunc<DeleteBookingM, DeleteBookingMVariables>,
  deleteManyBooking: MutationFunc<DeleteManyBooking, DeleteManyBookingVariables>
}
...
const initialState = {
  ...
  selectedRowIds: [] as BookingNode['id'][],
  currentPage: 1
}
...
class BookingListsQ extends Query<BookingConnection, BookingConnectionVariables> {}
...
class TableBookings extends Component<Props, State> {
  ...
  private onSelectChange = (record: BookingEdge) => {
  ...
  private onSelectAll = (selected: boolean, selectedRows: BookingEdge[]) => {
    if (selected) {
...
export default compose(
  graphql<{}, DeleteBookingM, DeleteBookingMVariables, {}>(DELETE_BOOKING, {
    name: "deleteBooking"
  }),
  graphql<{}, DeleteManyBooking, DeleteManyBookingVariables, {}>(DELETE_MANY_BOOKING, {
