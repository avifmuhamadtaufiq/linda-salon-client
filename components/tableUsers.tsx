...
import {
  UsersConnection_usersConnection_edges_node as UserNode,
  UsersConnection_usersConnection_edges as UserEdge,
  DeleteUser,
  DeleteUserVariables,
  DeleteManyUser,
  DeleteManyUserVariables,
  UsersConnection,
  UsersConnectionVariables,
  Role
...
type Props = {
  userPerPage: number,
  role: Role,
  deleteUser: MutationFunc<DeleteUser, DeleteUserVariables>,
  deleteManyUser: MutationFunc<DeleteManyUser, DeleteManyUserVariables>
}
...
class UserListsQ extends Query<UsersConnection, UsersConnectionVariables> {}
...
class TableUSers extends Component<Props, State> {
  ...
  private onSelectChange = (record: UserEdge) => {
  ...
  private onSelectAll = (selected: boolean, selectedRows: UserEdge[]) => {
    if (selected) {
...
export default compose(
  graphql<{}, DeleteUser, DeleteUserVariables, {}>(DELETE_USER, {
    name: "deleteUser"
  }),
  graphql<{}, DeleteManyUser, DeleteManyUserVariables, {}>(DELETE_MANY_USER, {
    name: "deleteManyUser"
  })
)(TableUSers)