...
import { DataUserForProductFragment, FilterProductByDateGivenQ, FilterProductByDateGivenQVariables } from 'types/schema-types'
...
export class ProductListsQ extends Query<FilterProductByDateGivenQ, FilterProductByDateGivenQVariables> {}
  ...
  render() {
    ...
    return (
      <ProductListsQ
        ...
        variables={{ first, skip, tag, startDate, endDate }}
