...
import { LindaSalonIcon } from 'components/icons/tes'
import { FormComponentProps } from 'antd/lib/form'
import { LoginM, LoginMVariables, MeQ } from 'types/schema-types'
...
type PropLogin = {
  meQ: DataValue<MeQ>,
  loginMutation: MutationFunc<LoginM, LoginMVariables> | undefined
} & FormComponentProps
        ...
        <Form layout="vertical" onSubmit={this.handleSubmit}>
          ...
          <FormItem>
            ...
            <div className="register-wrapper">
              Or <a onClick={() => Router.push('/signup-user')} >register now!</a>
            </div>
          </FormItem>
        </Form>
        </Content>
...
const WithLoginMutation = compose(
  graphql<{}, LoginM, LoginMVariables, {}>(LOGIN, {
    name: 'loginMutation',
  }),
  graphql<{}, MeQ, {}, {}>(ME, {
    name: 'meQ',
