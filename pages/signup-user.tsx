...
import { singUpM, singUpMVariables, MeQ } from 'types/schema-types'
...
type PropSignUp = {
  meQ: DataValue<MeQ>,
  singUpMutation: MutationFunc<singUpM, singUpMVariables> | undefined
} & FormComponentProps
...
const WithSingUpMutation = compose(
  graphql<{}, MeQ, {}, {}>(ME_QUERY, {
    name: 'meQ',
    options: {
      fetchPolicy: "network-only"
    },
  }),
  graphql<{}, singUpM, singUpMVariables, {}>(SINGUP_QUERY, {
    name: 'singUpMutation'
  })
)(SignUpUserUpWrapper)
